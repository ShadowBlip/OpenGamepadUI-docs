# -*- coding: utf-8 -*-
#
# OpenGamepadUI documentation build configuration file
...
ogp_site_name = "OpenGamepadUI documentation"
...
project = "OpenGamepadUI"
copyright = (
    "2022-present William Edwards, Derek Clark, and the OpenGamepadUI community (CC BY 3.0)"
)
author = "William Edwards, Derek Clark, and the OpenGamepadUI community"
...
supported_languages = {
    "en": "OpenGamepadUI %s documentation in English",
}
...
html_context = {
    ...
    "github_user": "shadowblip",  # Username
    "github_repo": "opengamepadui-docs",  # Repo name
